...
export default function About() {
  return (
    <div className={styles.resume}>
      <h1 className={styles.name} id="guthrie-albertson">
        Guthrie Albertson
      </h1>
      <div className={styles.body}>
        ...
        <div className={styles.indent}>
          ...
          <div className={styles.indent}>
            <p>
              <strong>Experience:</strong> Cloud hosting, System architecture,
              Web Development, Networking, UI/UX Design
            </p>
        ...
        <div className={styles.indent}>
          ...
          <div className={styles.indent}>
            ...
            <div className={styles.indent}>
              ...
              <p>
                Used and managed a large suite of software related to
                membership, events, communication, and security.
              </p>
            </div>
